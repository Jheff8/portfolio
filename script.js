...
const listOfElementsInformations = [
    ...
    {titleText: 'Find a coach', portugueseTitle: 'Encontre um coach', elementDescription: "Crafted during the final stages of an advanced Vue.js course, this website showcases the practical application of Vue.js concepts. It incorporates Firebase as its backend, enabling coaches to register and connect seamlessly", portugueseDescription: 'Desenvolvido durante as etapas finais de um curso avançado de Vue.js, este de site demonstra a aplicação prática de conceitos do Vue.js. Ele utiliza o Firebase como backend, permitindo que coaches se registrem e se conectem de forma fluida.', siteLink: 'https://vue-http-demo-8d232.web.app/', githubLink: 'https://github.com/Jheff8/findCoach'}
]
