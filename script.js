...
const listOfElementsInformations = [
    {titleText: 'Watch shop', portugueseTitle: 'Relojoaria', elementDescription: "I completed this project during the final stages of a Bootstrap course, where I had the opportunity to put my knowledge into practice. Through this hands-on experience, I showcased my ability to create responsive layouts, implement various Bootstrap components, and ensure cross-device compatibility.", portugueseDescription: "Eu concluí este projeto durante as etapas finais de um curso de Bootstrap, onde tive a oportunidade de colocar meus conhecimentos em prática. Através deste projeto, eu pude demonstrar minha habilidade em criar layouts responsivos, implementar diversos componentes do Bootstrap e garantir a compatibilidade em diferentes dispositivos.", siteLink:'https://jheff8.github.io/relojoaria/', githubLink: 'https://github.com/Jheff8https://github.com/Jheff8/relojoaria'},
